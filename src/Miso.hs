...
#else
#ifdef wasm32_HOST_ARCH
  _ <- liftIO $(JSaddle.Wasm.TH.evalFile "jsbits/delegate.js")
  _ <- liftIO $(JSaddle.Wasm.TH.evalFile "jsbits/diff.js")
  _ <- liftIO $(JSaddle.Wasm.TH.evalFile "jsbits/isomorphic.js")
  _ <- liftIO $(JSaddle.Wasm.TH.evalFile "jsbits/util.js")
#else
